...
@dataclass
class PROPSPoseDataParserConfig(DataParserConfig):
    """Nerfstudio dataset config"""

    _target: Type = field(default_factory=lambda: PROPSPose)
...
@dataclass
class PROPSPose(DataParser):
    """PROPSPose DatasetParser"""

    config: PROPSPoseDataParserConfig
    downscale_factor: Optional[int] = None
